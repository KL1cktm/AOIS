...
public class MethodCarnot {
    ...
    public List<String> getResult() {
        return this.carnotMap.getResult();
    }
    ...
    public void minimizePDNF() {
        ...
        this.token = '1';
        processing();
        this.carnotMap.removeKeys();
        this.carnotMap.definitionRectangleDNF();
    }
    public void minimizePCNF() {
        ...
        processing();
        this.carnotMap.removeKeys();
        this.carnotMap.definitionRectangleCNF();
    }
    ...
    private void formingCarnotMap(){
        ...
        switch (numberValues) {
            ...
            case 2:
                ...
                this.carnotMap.lineLength = 2;
                break;
            case 3:
                this.carnotMap = new CarnotMap3(this.keys);
                this.carnotMap.lineLength = 4;
                break;
            case 4:
